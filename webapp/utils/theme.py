...
THEMES: dict[str, dict[str, str | list[str]]] = {
    "Light": {
        ...
        "chart_grid": "rgba(104,121,145,0.14)",
        "chart_legend_bg": "rgba(255,255,255,0.72)",
        "chart_area_fill": "rgba(13,148,136,0.16)",
        "chart_forecast_band": "rgba(2,132,199,0.18)",
        "hover_background": "#ffffff",
        "colorway": ["#0d9488", "#2563eb", "#06b6d4", "#d97706", "#e11d48", "#7c3aed", "#0891b2", "#65a30d"],
    },
    "Dark": {
        "mode": "dark",
        "font_family": "Source Sans 3, Segoe UI, sans-serif",
        ...
        "chart_grid": "rgba(158,181,205,0.12)",
        "chart_legend_bg": "rgba(9,20,32,0.72)",
        "chart_area_fill": "rgba(94,234,212,0.2)",
        "chart_forecast_band": "rgba(56,189,248,0.2)",
        "hover_background": "#14283b",
        "colorway": ["#5eead4", "#60a5fa", "#38bdf8", "#fbbf24", "#fb7185", "#c4b5fd", "#22d3ee", "#bef264"],
    },
}
